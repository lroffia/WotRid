...
if __name__ == '__main__':
	...
	parser.add_argument("SEPA_update_address",help="Address for updating triples")
	parser.add_argument("SEPA_subscribe_address",help="Address for subscribing to triples")
